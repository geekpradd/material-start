# AngularJS Material-Start: My first serious date with Polymer

I tried Polymer before but never used it. Let's see whether Angular can change that or not. This is a fork containing custom code.
